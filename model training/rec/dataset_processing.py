...
def preprocess_dataset(data, test_size=0.15, random_state=1, pca_n=None):
    ...
    if pca_n is not None:
        ...
        pickle.dump(pca, open("pca_500.pkl","wb"))
    # PCA ends
    print(">>>>>>>>> PCA ENDS >>>>>>>>>")
...
dataset_DE = DatasetDE("rec", 0.1)
dataset_DE.create_dataset()

dataset_DE = DatasetDE("rec", 0.15)
dataset_DE.create_dataset()

dataset_DE = DatasetDE("rec", 0.2)
dataset_DE.create_dataset()
